...
var ACTIVATION = {
  ...
  // These cannot be parallelized because the derivative uses math.js for the
  // hyperbolic secant function.  The entire library would have to be serialized
  // and passed to the worker.
  //
  // /**
